...
CREATE TABLE t_setting (
   roulette_id int(11) NOT NULL AUTO_INCREMENT,
   activity_name varchar(255) DEFAULT NULL COMMENT '活动名称',
   act_s_time datetime DEFAULT NULL COMMENT '活动开始时间',
   act_e_time datetime DEFAULT NULL COMMENT '活动结束时间',
   act_status tinyint(4) NOT NULL COMMENT '活动状态（1：开 2：关）',
   max_num int(255) DEFAULT NULL COMMENT '累计单个用户最高参与次数',
   create_by        varchar(64)     default ''                 comment '创建者',
   create_time      datetime                                   comment '创建时间',
   update_by        varchar(64) 	 default ''			        comment '更新者',
   update_time      datetime                                   comment '更新时间',
...
-- ----------------------------
INSERT INTO t_setting VALUES (1, '抽奖活动1', '2023-11-01 00:00:00', '2023-11-11 00:00:00', '0', '1','admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '性别男');
